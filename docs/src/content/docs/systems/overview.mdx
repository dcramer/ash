...
| Section | Description |
|---------|-------------|
| [LLM](/systems/llm/) | LLM providers and model configuration |
| [Tools](/systems/tools/) | Tool system and execution |
| [Skills](/systems/skills/) | Configurable skill system |
| [Agents](/systems/agents/) | Built-in subagents |
| [Memory](/systems/memory/) | Storage and semantic search |
| [Sandbox](/systems/sandbox/) | Docker container isolation |
| [Providers](/systems/providers/) | Communication channels |
